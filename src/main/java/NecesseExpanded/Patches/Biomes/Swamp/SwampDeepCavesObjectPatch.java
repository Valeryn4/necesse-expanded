...
public class SwampDeepCavesObjectPatch 
{
    ...
    {
        BiomeStack.startPlace(LocalBiome, LocalRegion, BiomeRandom).chance(0.006).onlyOnTile(TileRegistry.deepSwampRockID).placeObject("willowtree");
        BiomeStack.startPlace(LocalBiome, LocalRegion, BiomeRandom).chance(0.005).onlyOnTile(TileRegistry.deepSwampRockID).placeObject("bambootree");
