...
public class AlchemistPatch 
{
  ...
  static void onExit(@This AlchemistHumanMob Mob) 
  {
      ...
      Mob.shop.addSellingItem("knockbackpotion", new SellingShopItem(20, 5)).setStaticPriceBasedOnHappiness(25, 50, 5).addKilledMobRequirement("spiderqueen");
      Mob.shop.addSellingItem("resistancepotion", new SellingShopItem(20, 5)).setStaticPriceBasedOnHappiness(25, 50, 5).addKilledMobRequirement("spiderqueen");
      ...
      Mob.shop.addSellingItem("strengthpotion", new SellingShopItem(20, 5)).setStaticPriceBasedOnHappiness(25, 50, 5).addKilledMobRequirement("spiderqueen");
      ...
      Mob.shop.addSellingItem("rangerpotion", new SellingShopItem(20, 5)).setStaticPriceBasedOnHappiness(25, 50, 5).addKilledMobRequirement("spiderqueen");
      Mob.shop.addSellingItem("rapidpotion", new SellingShopItem(20, 5)).setStaticPriceBasedOnHappiness(25, 50, 5).addKilledMobRequirement("spiderqueen");
