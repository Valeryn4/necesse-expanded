...
public class PlayerInventoryPatch {
    ...
    static boolean onEnter(@This PlayerInventoryManager Manager) {
        ...
        Manager.main.addItem(Manager.player.getLevel(), Manager.player, new InventoryItem("ironsword"), "startitem",
                null);
        Manager.main.addItem(Manager.player.getLevel(), Manager.player, new InventoryItem("ironpickaxe"), "startitem",
                null);
        Manager.main.addItem(Manager.player.getLevel(), Manager.player, new InventoryItem("ironaxe"), "startitem",
                null);
        Manager.main.addItem(Manager.player.getLevel(), Manager.player, new InventoryItem("ironshovel"), "startitem",
                null);
        ...
        Manager.main.addItem(Manager.player.getLevel(), Manager.player, new InventoryItem("recipebook"), "startitem",
                null);
        return true;
    }
}
