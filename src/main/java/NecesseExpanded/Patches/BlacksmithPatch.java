...
public class BlacksmithPatch 
{
  ...
  static void onExit(@This BlacksmithHumanMob Mob) {
    ...
    Mob.shop.addSellingItem("cutter", new SellingShopItem())
      .setStaticPriceBasedOnHappiness(50, 75, 5);
    Mob.shop.addBuyingItem("sapphire", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 25, 5);
    Mob.shop.addBuyingItem("amethyst", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 25, 5);
    Mob.shop.addBuyingItem("ruby", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 25, 5);
    Mob.shop.addBuyingItem("emerald", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 25, 5);
    Mob.shop.addBuyingItem("glacialshard", new BuyingShopItem())
      .setPriceBasedOnHappiness(20, 12, 2).addKilledMobRequirement("piratecaptain");
    Mob.shop.addBuyingItem("amber", new BuyingShopItem())
      .setPriceBasedOnHappiness(25, 15, 2).addKilledMobRequirement("piratecaptain");
    Mob.shop.addBuyingItem("phantomdust", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 20, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("slimematter", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 20, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("spidervenom", new BuyingShopItem())
      .setPriceBasedOnHappiness(35, 20, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("nightsteelbar", new BuyingShopItem())
      .setPriceBasedOnHappiness(40, 25, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("spideritebar", new BuyingShopItem())
      .setPriceBasedOnHappiness(40, 25, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("slimeum", new BuyingShopItem())
      .setPriceBasedOnHappiness(30, 20, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("omnicrystal", new BuyingShopItem())
      .setPriceBasedOnHappiness(60, 40, 2).addKilledMobRequirement("fallenwizard");
    Mob.shop.addBuyingItem("pearlescentdiamond", new BuyingShopItem())
      .setPriceBasedOnHappiness(60, 40, 2).addKilledMobRequirement("fallenwizard");
  }
}
