...
public class SettlerHappiness {
  public static void Update() {
    ...
    Settler.roomSizes.add(new RoomSize((GameMessage)new LocalMessage("settlement", "sizehuge"), 32, 20));
    ...
    Settler.dietThoughts.add(new DietThought((GameMessage)new LocalMessage("settlement", "dietextremely"), 8, 25));
  }
}
