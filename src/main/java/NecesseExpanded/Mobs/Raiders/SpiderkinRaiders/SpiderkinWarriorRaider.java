...
public class SpiderkinWarriorRaider extends SpiderkinRaiderTemplate {
    public SpiderkinWarriorRaider() {
        super();
        setMaxHealth(700);
    ...
    public void spawnDeathParticles(float knockbackX, float knockbackY) {
        for (int i = 0; i < 4; ++i) {
            this.getLevel().entityManager.addParticle(new FleshParticle(this.getLevel(), Textures.spiderkinWarrior.body,
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList,
        ...
        HumanDrawOptions humanOptions = (new HumanDrawOptions(level, MobRegistry.Textures.spiderkinWarrior))
                .sprite(sprite)
    ...
    public void drawOnMap(TickManager tickManager, Client client, int x, int y, double tileScale, Rectangle drawBounds,
        ...
        HumanDrawOptions humanOptions = (new HumanDrawOptions(this.getLevel(), MobRegistry.Textures.spiderkinWarrior))
