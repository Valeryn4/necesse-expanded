package NecesseExpanded.Mobs.Raiders.SkeletonRaiders;
...
public class SkeletonMinerRaider extends ItemAttackerRaiderMob
{
    HumanLook Look = new HumanLook();

    public SkeletonMinerRaider()
    {
        super(false);
        this.setSpeed(30F);
        this.setArmor(10);
        ...
        this.weapon = new InventoryItem("raider_bomb");
        ...
        SkeletonMinerRaider.lootTable = new LootTable
        (
          new LootItemInterface[]
          {
            ...
            (LootItemInterface)LootItem.between("ironbomb", 2, 4),
            (LootItemInterface) new LootItem("tungstenore", GameRandom.globalRandom.getIntBetween(4, 8)),
