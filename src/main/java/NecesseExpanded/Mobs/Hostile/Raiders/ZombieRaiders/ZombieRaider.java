package NecesseExpanded.Mobs.Hostile.Raiders.ZombieRaiders;
...
public class ZombieRaider extends ZombieRaiderTemplate {
  ...
  public void spawnDeathParticles(float knockbackX, float knockbackY) {
    for (int i = 0; i < 4; ++i) {
      this.getLevel().entityManager.addParticle(new FleshParticle(this.getLevel(), Textures.zombie.body,
  ...
  public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level,
    ...
    HumanDrawOptions humanOptions = (new HumanDrawOptions(level, MobRegistry.Textures.zombie)).sprite(sprite).dir(dir)
  ...
  public void drawOnMap(TickManager tickManager, Client client, int x, int y, double tileScale, Rectangle drawBounds,
    ...
    HumanDrawOptions humanOptions = (new HumanDrawOptions(this.getLevel(), MobRegistry.Textures.zombie)).sprite(sprite).dir(dir)
        .size(32, 32);
    if (this.helmet != null) {
      humanOptions.helmet(this.helmet);
    }
