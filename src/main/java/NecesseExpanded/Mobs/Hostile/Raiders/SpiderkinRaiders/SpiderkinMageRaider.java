...
public class SpiderkinMageRaider extends SpiderkinRaiderTemplate
{
    public SpiderkinMageRaider()
    {
        super();
        setMaxHealth(550);
    ...
    public void spawnDeathParticles(float knockbackX, float knockbackY) {
        for (int i = 0; i < 4; ++i) {
            this.getLevel().entityManager.addParticle(new FleshParticle(this.getLevel(), Textures.spiderkinMage.body,
    ...
    public void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList,
        ...
        HumanDrawOptions humanOptions = (new HumanDrawOptions(level, MobRegistry.Textures.spiderkinMage)).sprite(sprite)
    ...
    public void drawOnMap(TickManager tickManager, Client client, int x, int y, double tileScale, Rectangle drawBounds,
        ...
        HumanDrawOptions humanOptions = (new HumanDrawOptions(this.getLevel(), MobRegistry.Textures.spiderkinMage))
