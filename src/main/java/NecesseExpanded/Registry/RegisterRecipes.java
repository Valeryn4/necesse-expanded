...
public class RegisterRecipes 
{
    public static void Register()
    {
        ...
        Recipes.registerModRecipe(new Recipe("superiormanapotion", 1, RecipeTechRegistry.FALLEN_ALCHEMY, new Ingredient[] { new Ingredient("glassbottle", 1), new Ingredient("caveglow", 3), new Ingredient("iceblossom", 4), new Ingredient("sunflower", 4) }).showBefore("superiormanapotion"));
