...
public class NinjaRaid extends SettlementRaidLevelEvent {
    ...
    public GameMessage getApproachMessage(GameMessage settlementName, boolean isFirst) {
        return (GameMessage) new LocalMessage("misc", "raidapproaching", new Object[] {
                ...
                "raidtype", Localization.translate("misc", "ninja_raiders")
        });
    }
    ...
    public GameMessage getDefeatedMessage() {
        return (GameMessage) new LocalMessage("misc", "raiddefeated", "raidtype",
                Localization.translate("misc", "ninja_raiders"));
    }
    ...
    public NinjaRaid(ServerSettlementData Data, SettlementRaidOptions Options) 
    {
        ...
        {
            this.loadouts.add(new SettlementRaidLoadout("ninja_raider"));
        }
    }
}
