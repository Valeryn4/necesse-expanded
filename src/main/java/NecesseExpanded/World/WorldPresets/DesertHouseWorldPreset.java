...
import NecesseExpanded.World.Presets.DesertHousePreset;
...
public class DesertHouseWorldPreset extends SimpleGenerationPreset
{
    public DesertHouseWorldPreset() 
    {
        super(100, true, false, false, false, BiomeRegistry.DESERT);
    }

    public Preset getPreset(GameRandom arg0) 
    {
        return (Preset) new DesertHousePreset();
    }
