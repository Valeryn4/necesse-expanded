...
public class CaveTreasureChest extends PlaceableItem
{
    public CaveTreasureChest() 
    {
        super(99, true);
    ...
    {
        InventoryItem Coins = new InventoryItem("coin", GameRandom.globalRandom.getIntBetween(50, 100));
